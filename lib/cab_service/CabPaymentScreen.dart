...
import 'package:emart_customer/model/FlutterWaveSettingDataModel.dart';
...
import 'package:emart_customer/model/PayPalCurrencyCodeErrorModel.dart' as payPalCurrModel;
import 'package:emart_customer/model/PayStackSettingsModel.dart';
import 'package:emart_customer/model/RazorPayFailedModel.dart';
import 'package:emart_customer/model/StripePayFailedModel.dart';
import 'package:emart_customer/model/User.dart';
import 'package:emart_customer/model/createRazorPayOrderModel.dart';
import 'package:emart_customer/model/getPaytmTxtToken.dart';
import 'package:emart_customer/model/offer_model.dart';
import 'package:emart_customer/model/payStackURLModel.dart';
import 'package:emart_customer/model/paypalErrorSettle.dart';
import 'package:emart_customer/model/paypalPaymentSettle.dart' as payPalSettel;
...
import 'package:emart_customer/services/paypalclientToken.dart';
import 'package:emart_customer/services/paystack_url_genrater.dart';
import 'package:emart_customer/services/rozorpayConroller.dart';
import 'package:emart_customer/ui/wallet/MercadoPagoScreen.dart';
import 'package:emart_customer/ui/wallet/PayFastScreen.dart';
import 'package:emart_customer/ui/wallet/payStackScreen.dart';
...
class CabPaymentScreen extends StatefulWidget {
  ...
  const CabPaymentScreen({Key? key, required this.cabOrderModel}) : super(key: key);
...
class _CabPaymentScreenState extends State<CabPaymentScreen> {
  ...
  void initState() {
    ...
    setAllFalse(value: widget.cabOrderModel!.paymentMethod.toString() == "cod" ? "Cash" : widget.cabOrderModel!.paymentMethod.toString());
          ...
          onPressed: () async {
            ...
            if (razorPay) {
              ...
              FireStoreUtils.createPaymentId().then((value) {
                ...
                FireStoreUtils.topUpWalletAmount(serviceType: "cab-service", paymentMethod: "Wallet".tr(), isTopup: false, orderId: widget.cabOrderModel!.id, amount: getTotalAmount(), id: paymentID)
                    .then((value) {
            ...
            children: [
              ...
              Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        ((taxLable.isNotEmpty) ? taxLable.toString() : "Tax".tr()) + " ${(taxType == "fix") ? "(${taxAmount} $symbol)" : "($taxAmount %)"}",
                        style: const TextStyle(fontSize: 16),
                      ),
                      Text(
  ...
  getPaymentSettingData() async {
    ...
    futurecod = fireStoreUtils.getCod() as Future<CodModel?>?;
  }
  ...
  _flutterWaveInitiatePayment(
    ...
    final flutterwave = Flutterwave(
      amount: getTotalAmount().toStringAsFixed(decimal).trim(),
      currency: currencyData!.code,
      style: style,
  ...
  payStackPayment(BuildContext context) async {
    var amount = (double.parse(getTotalAmount().toStringAsFixed(decimal)) * 100).toString();
    print(amount);
