...
import 'package:emart_customer/cab_service/CabPaymentScreen.dart';
import 'package:emart_customer/cab_service/cab_order_screen.dart';
import 'package:emart_customer/cab_service/dashboard_cab_service.dart';
import 'package:emart_customer/cab_service/intercity_payment_selection_screen.dart';
...
import 'package:emart_customer/ui/chat_screen/chat_screen.dart';
...
class _CabInterCityServiceScreenState extends State<CabInterCityServiceScreen> {
  ...
  getVehicleType() async {
    await FireStoreUtils.getVehicleType().then((value) {
      setState(() {
        vehicleType = value as List<VehicleType>;
      });
    });

    await FireStoreUtils.getPopularDestination().then((value) {
      setState(() {
        popularDestination = value  as List<PopularDestination>;
