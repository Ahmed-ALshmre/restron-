...
class _ParcelOrderDetailScreenState extends State<ParcelOrderDetailScreen> {
  ...
  void initState() {
    ...
    totalAmount = "$symbol ${(double.parse(orderModel!.subTotal!.toString()) - double.parse(orderModel!.discount!.toString()) + taxCalculation(orderModel!)).toStringAsFixed(2)}";
    super.initState();
  }
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text(
              symbol + double.parse(orderModel!.subTotal!).toStringAsFixed(2),
              style: TextStyle(
                fontSize: 16,
        ...
        Row(
          ...
          children: [
            ...
            Text(
              symbol + taxCalculation(orderModel!).toStringAsFixed(2),
              style: TextStyle(
                fontSize: 16,
                fontWeight: FontWeight.w700,
                color: isDarkMode(context) ? Colors.white : Colors.black,
