...
class _VehicleTypeScreenState extends State<VehicleTypeScreen> {
  ...
  getCompanyDriver(String vehicleType) async {
    driverListStrem = FireStoreUtils().getRentalCompanyDriver(widget.rentalOrderModel, vehicleType, rentalOrderModel!.pickupDateTime!, rentalOrderModel!.dropDateTime!).asBroadcastStream();
  }
                    ...
                    if (snapshot.data?.isNotEmpty ?? false) {
                      ...
                      snapshot.data!.forEach((element) {
                        if (element.rentalBookingDate!.isNotEmpty) {
                          ...
                          print(widget.rentalOrderModel!.pickupDateTime!.toDate());
                          print(widget.rentalOrderModel!.dropDateTime!.toDate());
                          print(element.rentalBookingDate!.first.toDate());
                          print(element.rentalBookingDate!.last.toDate());
                          print(widget.rentalOrderModel!.pickupDateTime!.toDate().isAfter(element.rentalBookingDate!.first.toDate()));
                          print(widget.rentalOrderModel!.pickupDateTime!.toDate().isBefore(element.rentalBookingDate!.last.toDate()));
                          print(widget.rentalOrderModel!.pickupDateTime!.toDate().isAfter(element.rentalBookingDate!.first.toDate()) &&
                                            ...
                                            Expanded(
                                              child: Row(
                                                children: [
                                                  ...
                                                  Text(driverList[index].reviewsCount != 0 ? (driverList[index].reviewsSum / driverList[index].reviewsCount).toStringAsFixed(1) : 0.toString(),
                                                      style: const TextStyle(
                                                        letterSpacing: 0.5,
                                                      )),
                                                ],
