...
import 'package:emart_customer/ui/phoneAuth/PhoneNumberInputScreen.dart';
...
class _SignUpState extends State<SignUpScreen> {
  ...
  _signUpWithEmailAndPassword() async {
    ...
    dynamic result = await FireStoreUtils.firebaseSignUpWithEmailAndPassword(email!.trim(), password!.trim(), _image, firstName!, lastName!, mobile!,referralCode.toString());
    await hideProgress();
