...
import 'package:emart_customer/ui/vendorProductsScreen/widgets/ficon_button.dart';
import 'package:emart_customer/ui/vendorProductsScreen/widgets/helper.dart';
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("valid till ".tr() + getDate(offerList[index].expireOfferDate!.toDate().toString())!, style: const TextStyle(letterSpacing: 0.5, color: Color(0Xff696A75)))
                    ],
                  ),
                ],
              )),
