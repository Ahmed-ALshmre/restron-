...
import 'package:emart_customer/cab_service/cab_order_detail_screen.dart';
...
import 'package:emart_customer/model/paypalClientToken.dart';
...
import 'package:emart_customer/parcel_delivery/parcel_ui/parcel_order_detail_screen.dart';
import 'package:emart_customer/rental_service/model/rental_order_model.dart';
import 'package:emart_customer/rental_service/renatal_summary_screen.dart';
...
class WalletScreenState extends State<WalletScreen> {
  ...
  _paypalPayment() async {
    PayPalClientTokenGen.paypalClientToken(paypalSettingData: paypalSettingData!).then((value) async {
      ...
      var request = BraintreePayPalRequest(amount: _amountController.text, currencyCode: currencyData!.code, billingAgreementDescription: "djsghxghf", displayName: 'Emarts company');
