...
import 'package:emart_customer/ui/fullScreenImageViewer/FullScreenImageViewer.dart';
import 'package:emart_customer/ui/vendorProductsScreen/photos.dart';
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text("In".tr() + " ${hour.toString().padLeft(2, "0")}h ${minute.toStringAsFixed(0).padLeft(2, "0")}min",
                                        style: const TextStyle()).tr()
                                  ],
                                ),
                              ),
                            ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                widget.vendorModel.restaurantMenuPhotos.isEmpty
                                    ...
                                    : GestureDetector(
                                        onTap: () {
                                          push(context, StoreMenuPhoto(restaurantMenuPhotos: widget.vendorModel.restaurantMenuPhotos));
                                        },
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(widget.vendorModel.restaurantCost == 0 ? "Approx cost is not added".tr() : "Cost for two".tr() + "$symbol${widget.vendorModel.restaurantCost} (Approx)",
                                          style: const TextStyle()).tr()
                                    ],
                                  ),
                                ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          "${"Fix Price".tr() == "Fix Price".tr() ? "\$" : ""}${100}${"Percentage".tr() == "Percentage".tr() ? "% OFF" : " OFF"}",
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () async {
                            ...
                            FireStoreUtils.sendFcmMessage(
                                'New Booking Request!'.tr(), '${MyAppState.currentUser!.firstName}' " has Request for Table Booking.", widget.vendorModel.fcmToken);
