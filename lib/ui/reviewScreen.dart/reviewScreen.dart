...
import 'package:emart_customer/ui/fullScreenImageViewer/fullscreenimage.dart';
                            ...
                            Card(
                                ...
                                child: SizedBox(
                                    ...
                                    child: Column(children: [
                                      ...
                                      Container(
                                          alignment: Alignment.center,
                                          child: Text(widget.product.name, style: TextStyle(color: isDarkMode(context) ? const Color(0XFFFDFEFE) : const Color(0XFF000003), fontSize: 20))),
                                      const SizedBox(
                                        height: 15,
                                      ),
                                      RatingBar.builder(
                                      ...
                                      child: SingleChildScrollView(
                                        child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(hintText: 'Type comment....'.tr(), hintStyle: const TextStyle(color: Color(0XFF8A8989)), border: InputBorder.none),
                                              maxLines: null,
                                            )),
                                      ),
                                    ))),
